  ...
  for (const record of event.Records) {
    if (record.eventName === 'INSERT') {
      ...
      echo "Checking the file type"
        ...
        echo "File is a valid shell script"
        ...
        echo "Error: File is not a valid shell script. Detected file type: $file_type"
        exit 1
        fi
      ...
      /** Note: For production, I might install cloudwatch agent to centralize logs */
